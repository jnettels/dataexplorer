...
plot_size_and_tools = {'tools': ['pan', 'wheel_zoom', 'box_select',
...
#layout1 = layout(wb_list, wb3, [grid])
layout1 = layout([wb1, wb2, wb3], [grid])
#layout1 = layout([wb1, wb2, wb3, legend_fig], [grid])
